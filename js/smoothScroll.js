...
links.forEach((link) => { // перебор массива ссылок, чтобы получить каждую отдельно
    link.addEventListener('click', (event) => { // обработчик событий на каждую ссылку навбара
        ...
        if (section) { // если щелчок по ссылке происходит плавный скролл
